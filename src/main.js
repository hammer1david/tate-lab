  ...
  row.innerHTML = `
    ...
    <label class="history-workout-label">
      ...
      <input
        ...
        placeholder="e.g. 5x1000 @3:14 / 60s"
      />
    </label>
...
function renderCandidateCard(
  ...
  return `
    ...
    <div class="meta-line">
      ...
      · Learned modifier:
      ${candidate.learnedModifier.toFixed(
        3
      )}
    </div>
