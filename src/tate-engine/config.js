export const ENGINE_VERSION = '0.1.0-lab';
...
export const thresholdDoseByTolerance = Object.freeze({
  low: { minMinutes: 15, maxMinutes: 25, defaultReps1000: 5 },
  established: { minMinutes: 20, maxMinutes: 35, defaultReps1000: 6 },
  high: { minMinutes: 25, maxMinutes: 45, defaultReps1000: 8 },
  very_high: { minMinutes: 30, maxMinutes: 60, defaultReps1000: 10 },
});
...
export const racePhaseBias = Object.freeze({
  Base: { simplicity: 1.0, specificity: 0.65 },
  Loading: { simplicity: 0.9, specificity: 0.85 },
  Sharpening: { simplicity: 0.85, specificity: 1.0 },
  Taper: { simplicity: 0.95, specificity: 1.0 },
});
